...
Provider will generate and deliver exclusive Motor Vehicle Accident ("MVA") leads to Client in the following state(s): {{contact.custom_field.state}}.
...
Based on current {{contact.state}} campaign performance, approximately 10-15% of qualified Leads convert to signed cases. Approximately 15% of Leads involve commercial vehicle or catastrophic injury cases.
...
Provider may adjust ad creative, targeting, and delivery based on campaign data to improve performance.
...
Full investment amount is due prior to campaign launch. Payment may be made via credit card, ACH, or wire transfer.
...
Leads may only be replaced for the following reasons:
...
Disqualification requests must be submitted within 24 hours of Lead delivery.
