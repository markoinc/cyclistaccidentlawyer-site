...
- **Business name:** KuriosBrand LLC
- **Address:** 361 Falls Rd, Grafton, WI
- Telegram handle: @Geetoh_Inc
- LinkedIn: https://www.linkedin.com/in/mark-gundrum-kurios/

### Current Focus: MVA Lead Gen
- Generating motor vehicle accident leads for lawyers
- Running Meta ads → booking calls (5-7/week)
- Cost per call: ~$180 (campaign level), ~$300 including testing
- Working as **referral partner** with:
  - Max & Jeremy @ **Cases on Demand**
  - Patrick @ **Inquired Esquire**
- Primarily focused on client acquisition right now

### Legacy: Concrete Rank & Rent
- Built local SEO sites + Google Business Profiles for concrete contractors
- Rank and rent model (rank sites, rent leads)
- Some sites still generating leads but no active clients — needs to monetize
